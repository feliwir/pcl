...
namespace pcl
{
  namespace rec_3d_framework
  {
    ...
    protected:
      ...
      typename std::shared_ptr<CRHEstimation<PointInT, FeatureT> > crh_estimator_;
    ...
    public:
      ...
      void
      setFeatureEstimator (typename std::shared_ptr<CRHEstimation<PointInT, FeatureT> > & feat)
      {
        crh_estimator_ = feat;
      }
