  ...
  namespace rec_3d_framework
  {
    ...
    template<template<class > class Distance, typename PointInT, typename FeatureT>
      ...
      protected:
        ...
        typename std::shared_ptr<GlobalEstimator<PointInT, FeatureT> > estimator_;
      ...
      public:
        ...
        void
        setFeatureEstimator (typename std::shared_ptr<GlobalEstimator<PointInT, FeatureT> > & feat)
        {
          estimator_ = feat;
        }
