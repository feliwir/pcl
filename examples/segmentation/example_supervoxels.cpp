...
void printText (std::shared_ptr<pcl::visualization::PCLVisualizer> viewer);

/** \brief Removes info text in the specified PCLVisualizer
 *  \param[in] viewer_arg The PCLVisualizer to modify  */
void removeText (std::shared_ptr<pcl::visualization::PCLVisualizer> viewer);
...
main (int argc, char ** argv)
{
  ...
  NormalCloudT::Ptr input_normals = std::make_shared < NormalCloudT > ();
